...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_BACKEND_PATH_URL}/api/auth`, { email, password });
      
      const { access_token } = response.data.data; // Adjusted to access token from data
